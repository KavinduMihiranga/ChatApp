...
public class ClientThreeLoginController implements Initializable {
    ...
    public void loginButtonOnAction(ActionEvent actionEvent) throws IOException {
        ...
        window.setScene(new Scene(FXMLLoader.load(getClass().getResource("../view/ClientFormThree.fxml"))));
